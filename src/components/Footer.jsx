...
const Footer = () => {
  return (
    <div className="w-full p-20 h-screen bg-zinc-900 flex gap-5">
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading">
          <h1 className="text-[8vw] font-medium uppercase leading-none -mb-5">
            Eye-
          </h1>
          <h1 className="text-[8vw] font-medium uppercase leading-none -mb-5">
            Opening
      ...
      <div className="w-1/2">
        ...
        <div className="dets font-neue-montreal mt-10">
          {["Facebook", "Instagram", "Twitter"].map((item, index) => (
            <a href="#" key={index} className="block text-xl font-light">
              {item}
            </a>
          ))}
        </div>
